package anudip.JPAHibernate.entity;
...
public class CustomerDetails
{
	//annotation for primary key
		...
		public void setPurchaseId(int customerId) {
		...
		public String toString() {
			return "Customerdetails [CustomereId=" + customerId + ", CustomerName=" + cname + ", MailId=" + mailId + ", Phoneno="
